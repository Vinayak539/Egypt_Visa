                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>Worlds <span id="js-rotating">most trusted VISA Service</span></h1>
                            <p class="p-heading p-large">We provide expert team to create great value for immigration. Our certified & reliable Immigration Consultant professionals can help you get a positive decision on your case.</p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <h2>Egypt Visa</h2>
                        <p>The times when someone is planning to travel to Egypt from India, a visa for Egypt must be issued prior to the journey. There are several benefits to the visa. With the different types, the visa will allow the holder to travel through the country, do business with the Egyptian companies, and even visit friends and family in the country. Some of the visas are long term while some are short term. The stay permitted and the validity of the visa will vary as per the type of the visa as well.</p>
           ...
           <div class="row">
               <div class="col-lg-6 col-sm-12">
                <h1 class="white">About Us</h1>
                   <p class="white">In today’s period, customer support is the most critical factor to one’s success in business, we intend to continuously deliver highest levels of satisfaction and keep raising the bar for ourselves. Travel and Visa sector has been one of the most dynamic among all other businesses. We at Egypt Visas shall proactively upgrade, knowledge and skills of the team members to cope up with the ever changing environment.<br><br>

Our Expertise of high end Visas puts us at a higher pedestal than competition. We do provide visas EGYPT. Our services are personalized to each and every customer and delivered to their doorstep as they desire. Ours shall be a one stop shop for all your travel needs. Be it documentation for visa application, submission, collection of passport from the authority, procuring travel Insurance, hunting for best possible deals on Hotels, flightsand sightseeing across the globe.<br><br>


Our Services shall come with pristine interest of the clients on our mind. We at Egypt Visa shall offer end to end services to the avid travelers of the Mobile Generation, be it Passports, visas, Documentation, attestation, Domestic or international Hotels, Sight Seeing, Travel Insurance etc.</p>

               </div>

<div class="col-lg-6 col-sm-12"  >
    <img src="assets/images/EgyptAir.png" width="700" style=" transform: rotate(10deg);">
</div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/family.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Family Visa</h3>
                            <p>Ensuring Certifies family visa on time.</p>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/family_visa">DETAILS</a>
    ...
    <div class="swiper-slide">
         <!-- Card -->
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/work.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Work Visa</h3>
                            <p>Bringing your work visa right on time !</p>
                            <!-- <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/work_visa">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
       ...
       <div class="swiper-slide">
         <!-- Card -->
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/immigration.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Immigrant Visa</h3>
                            <p>Receive instant access to Immigrate Visa</p>
                           <!--  <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/immigration_visa">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
    </div>
       ...
       <div class="swiper-slide">
         <!-- Card -->
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/student.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Student Visa</h3>
                            <p>Get our student visa without sanctioned withoud delays !</p>
                           <!--  <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Maintaining the leader status</div>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/student_visa">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
       ...
       <div class="swiper-slide">
         <!-- Card -->
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/tourist.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Tourist Visa</h3>
                            <p>Get Assurance on tourist visa without delay !</p>
                            <!-- <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Maintaining the leader status</div>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/tourist_visa">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
               </div>
                ...
                <div class="swiper-slide"> 
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/transit.jpg" alt="alternative">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Transit Visa</h3>
                            <p>No need to worry about transit visa anymore.</p>
                           <!--  <ul class="list-unstyled li-space-lg">
                                <li class="media">
                                    <i class="fas fa-square"></i>
                                    <div class="media-body">Maintaining the leader status</div>
                        ...
                        <div class="button-container">
                            <a class="btn-solid-reg page-scroll" href="/home/transit_visa">DETAILS</a>
                        </div> <!-- end of button-container -->
                    </div>
                    <!-- end of card -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">I need to attend Business conference in Egypt and was panic because I have not sufficient time to arrange all things for my visa than with reference of my friend I contact them and they done all for me in time and I am going now for my conference.</div>
                                            <div class="testimonial-author">Jude Thorn - Client</div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">This team helped me for my visit visa in no time with positive outcome and I am very happy. </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">I am happy and satisfied with the services provided by team.</div>
                                            <div class="testimonial-author">Roy Smith - Customer</div>
                                        </div>
                                    </div>        
                                </div> <!-- end of swiper-slide -->
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">Can't thank them enough for their help with my visit application. Super easy to work.</div>
                                            <div class="testimonial-author">Ronald Spice - Client</div>
                                        </div>
                                    </div>
                                </div> <!-- end of swiper-slide -->
                                <!-- end of slide -->
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">I need visit visa of Egypt as soon as possible because of medical treatment and this team arranged all in just 3 weeks . I am very thankful to them</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">All team members are hardworking and supporting and always there throughout the process of my visa application</div>
